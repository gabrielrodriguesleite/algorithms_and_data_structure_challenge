...
describe('===== 1 - Teste da função filtro: =====', () => {
  ...
  test('retorna uma string explicando o parametro "type" da função.', () => {
    expect(filter(TEST_ARRAY, ''))
      .toEqual('Use "letters", "numbers" ou "highest" in the type argument.'
      )
  })
})
...
describe('===== 3 - Testes para newID: =====', () => {
  const IDS = '1234567'.split('').map(() => newID())

  test.each(IDS)('a função deve retornar uma string contendo 4 grupos de '
